        ...
        <Slider {...settings}>
            <div>
                <p className='review__text'>"Lorem ipsum dolor sit amet consectetur
                    adipisicing elit. Perferendis atque, quam minus totam maiores laborum! Impedit
                    consectetur illum aliquid odit. Odit dolore ipsum quod debitis nostrum necessitatibus
                    quis dolorem quas!"</p>
            ...
            <div>
                <p className='review__text'>"Lorem ipsum dolor sit amet consectetur
                    ...
                    quis dolorem quas!"</p>
                <div className='slider__content d-flex align-items-center gap-3'>
                    <img src={ava04} alt='ava03' className='rounded'></img>
                    <h6>Jhon Doe</h6>
                </div>
            </div>
        </Slider>
